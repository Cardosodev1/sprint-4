        ...
        <section className="pt-20 flex flex-col text-center bg-white mt-28">
            ...
            <ul className="flex flex-col md:flex-row justify-around mb-10 px-4">
                <li className="flex flex-col items-center mb-10 md:mb-0">
                    <Image src={Diagnostico} alt="chatbot de diagnóstico" className="w-44 h-36 md:w-56 md:h-48" />
                ...
                <li className="flex flex-col items-center mb-10 md:mb-0">
                    <Image src={Orcamento} alt="calculadora para o orçamento" className="w-32 h-36 md:w-48 md:h-48" />
                ...
                <li className="flex flex-col items-center mb-10 md:mb-0">
                    <Image src={Oficina} alt="ferramentas de oficina" className="w-40 h-36 md:w-56 md:h-48" />
